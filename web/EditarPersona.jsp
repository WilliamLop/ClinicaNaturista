...
<html>
    ...
    <body>
        ...
        <form action="Persona.do?a=update" method="post" >
            <% Persona prsn = (Persona)request.getAttribute("EditarPersona");%>
            <h3>Informaci&oacute;n personal :</h3>
            <label>* Nombre :</label>
            <input type="text" name="txtNombre" placeholder="Name" value="<%=prsn.getNombre()%>" >
            <label>* Apellido :</label>
            <input type="text" name="txtApellido" placeholder="Last Name" value="<%=prsn.getApellido()%>" >
            <label>* Documento de Identificaci&oacute;n :</label>
            <input type="text" name="txtDocumentid" placeholder="Identification Number" value="<%=prsn.getDocumentid() %>">
            <label>* Fecha de Nacimiento :</label>
            <input type="date" name="txtFechaNacimiento" placeholder="DD/MM/AAAA" value="<%=prsn.getFechaNacimiento() %>">
            <label>* Genero :</label>
            <label>
            ...
            <input type="text" name="txtTelefono" placeholder="Telephone"  value="<%=prsn.getTelefono() %>">
            <label>* Correo :</label>
            <input type="email" name="txtCorreo" placeholder="E-Mail"  value="<%=prsn.getCorreo()%>">
